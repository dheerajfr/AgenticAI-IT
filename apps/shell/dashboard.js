...
function calculateHealth(data) {
  ...
  if (data.releases && data.releases.some(r => (r.cab_status && String(r.cab_status).toLowerCase() === 'reject') || (r.cab_decision && String(r.cab_decision).toLowerCase() === 'reject') || (r.status && String(r.status).toLowerCase() === 'rejected'))) return 'At Risk';
  return 'Healthy';
}
